...
python3 train_ranking_model.py mse_subgraph_mpnet_ranking_T5LargeSSM \
    /mnt/storage/le/shortest_path/new_subgraph_dataset/t5-large-ssm/MINTAKA/mintaka_train_labeled.jsonl \
    /mnt/storage/le/shortest_path/new_subgraph_dataset/t5-large-ssm/MINTAKA/mintaka_validation_labeled.jsonl \
    /mnt/storage/le/shortest_path/new_subgraph_dataset/t5-large-ssm/MINTAKA/mintaka_test_labeled.jsonl \
    --output_path /mnt/storage/QA_System_Project/subgrraphs_reranking_runs/ \
    --model_name sentence-transformers/all-mpnet-base-v2 \
    --classification_threshold 0.5 \
    --wandb_on True \
