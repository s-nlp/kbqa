...
sys.path.append("/workspace/kbqa/kbqa")
...
from kbqa.wikidata.wikidata_entity_to_label import (  # pylint: disable=import-error
    WikidataEntityToLabel,
)
from kbqa.wikidata.wikidata_redirects import (  # pylint: disable=import-error
    WikidataRedirectsCache,
)
from kbqa.wikidata.wikidata_subgraphs_retriever_igraph import (  # pylint: disable=import-error
    SubgraphsRetrieverIgraph,
)
from kbqa.wikidata.wikidata_shortest_path_igraph import (  # pylint: disable=import-error
